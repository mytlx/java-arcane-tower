package com.mytlx._12_reflection_factory_mode;
...
public class Factory {
    ...
    public static void main(String[] args) {
        Car car = createInstance("com.mytlx._12_reflection_factory_mode.Car", Car.class);
        Optional.ofNullable(car).ifPresent(Car::drive);

        Bike bike = createInstance("com.mytlx._12_reflection_factory_mode.Bike", Bike.class);
